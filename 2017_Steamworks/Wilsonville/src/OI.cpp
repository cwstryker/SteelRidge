...
OI::OI() {
    ...
    rightthumb.reset(new JoystickButton(xbox.get(), 10));
    rightthumb->WhenPressed(new gearpunch());
    leftthumb.reset(new JoystickButton(xbox.get(), 9));
    leftthumb->WhenPressed(new gearretract());
    l1.reset(new JoystickButton(xbox.get(), 5));
    l1->WhenPressed(new climbstop());
    y.reset(new JoystickButton(xbox.get(), 4));
